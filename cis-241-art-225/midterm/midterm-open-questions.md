...
### **Question 2: HTML Forms and Input Types (14 points)**
...
**Grading:** 5 input types (5), Data descriptions (5), Validation/features (4)

---

### **Question 3: Code Debugging ⚠️ (10 points)**
...
**Grading:** Identifying 7 errors (3), Explaining why wrong (3), Corrected code (4)

---

### **Question 4: HTML Accessibility Attributes (10 points)**
...
### **Question 5: Code Analysis and Improvement ⚠️ (1 points)**
...
**Grading:** 5 improvements identified (0.4), Explaining problems (0.3), How to fix (0.3)
...
|----------|--------|-------|
| Q1 | 15 | Semantic HTML |
| Q2 | 14 | Forms & Input Types |
| Q3 | 10 | Code Debugging ⚠️ |
| Q4 | 10 | Accessibility |
| Q5 | 1 | Code Analysis ⚠️ |
| **Total** | **50** | |
