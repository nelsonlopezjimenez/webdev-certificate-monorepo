...
## Quarter 3 Curriculum Guide | 12 Weeks | Mon–Thu, 3 hrs/day
...
| **7** | JWT Basics + Auth Concepts | Understand tokens, sign/verify |
| **8** | Signup / Login / Protected Routes | Working auth backend |
| **9** | Frontend Integration (React + JWT) | Login form hits real backend |
| **10** | Advanced Token Handling + Security | Refresh tokens, httpOnly cookies |
| **11** | Intro to Hono + SSR Modern Approaches | Side-by-side comparison with Express |
| **12** | Capstone Project + Code Review | Full-stack MERN mini-app |
...
## Tuesday — Your First Node.js Scripts
...
## Wednesday — npm: The Package Ecosystem
...
## Thursday — Reusable Code + Mini Project
...
### 🔨 Week 1 Project: "Node Profile Generator"
...
# 📅 WEEK 2 — Express v4 from Scratch
...
### 🔨 Week 2 Project: "Book Tracker API"
